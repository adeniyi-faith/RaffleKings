...
function rk_register_admin_pages() {
    ...
    // Phase 3 item 36d — "Bonus System (Trap)" removed; see the retirement note above rk_render_winners_manager_page().
...
// Phase 3 item 36d — the "Bonus System (Trap)" admin page (and the
// underlying retention-bonus/aggressive-push cron jobs it controlled)
// was retired outright in item 35d, per the product owner's explicit
// direction: the same manipulative pattern as the fake activity
// counters and fake live-draw schedule Phase 0/Phase 2 already tore out
// elsewhere. This page controlled functionality that no longer exists,
// so the page itself — not just its cron hooks — is removed here.
